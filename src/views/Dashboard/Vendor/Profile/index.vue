    ...
    <div class="dashboardVendor__right__header">
      <div class="dashboardVendor__right__header">
        ...
        <div class="dashboardVendor__right__header__action">
          <router-link :to="{name: 'editVendorProfile'}">
      ...
      <div class="dashboardVendor__right__content__iklan">
        <div class="box">
          ...
          <div class="box__content">
            <img
              src="https://images.unsplash.com/photo-1540151812223-c30b3fab58e6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=4050&q=80"
              alt
            />
          </div>
          <div class="box__footer">
            <button class="btn-regular secondary">iklan anda akan habis pada tanggal 30 Januari 2020</button>
          </div>
        </div>
      </div>
    </div>
    <div class="dashboardVendor__right__footer"></div>
  </div>
</template>

<script>
export default {
  name: "pena-vendorProfile",
  components: {},
  props: {},
  data() {
    return {};
